...
public class DrivingSimulator {
    ...
    public DrivingSimulator(UserRepository userRepository, LocationRepository locationRepository) {
    ...
    public void driveRoute(Route route, UUID driverId) throws Exception {
        ...
        List<OsrmRouteService.Point> fullRoute = getPointRoute(toPoints(stops));
    ...
    private void driveAsync(List<OsrmRouteService.Point> points, UUID driverId) {
